This is a Vala based repository for interacting with a Hashnode REST API. We aim for a casual laid back atmosphere, but deliver serious and reliable code.
...
## Repository Structure
  ...
  * `src/`: Contains the source code for the application.
    * Hashnode.vala: Compiles for libsoup2.4
    * Hashnode3.vala: Compiles for libsoup3
